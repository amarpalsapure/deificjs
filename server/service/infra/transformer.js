...
var _toTag = function (tag) {
    ...
    if (tag.get('viewcount')) response.viewcount = _toInt(tag.get('viewcount'));
    if (tag.aggregate('questioncount')) response.questioncount = _toInt(tag.aggregate('questioncount').all);
    if (tag.get('active')) response.active = _toISODateFormat(tag.get('active'));
    if (tag.get('__createdby')) response.author = tag.get('__createdby');
    if (tag.get('edited')) response.edited = _toISODateFormat(tag.get('edited'));
    if (tag.get('editedby')) response.editor = tag.get('editedby');
    if (tag.get('editcount')) response.editcount = _toInt(tag.get('editcount'));
    return response;
};
