exports.findAll = function(req, res) {
	...
	var query = new Appacitive.Queries.GraphProjectQuery('answer', ids);
	query.fetch(function (answers) {
		...
		answers.forEach(function(answer){
			response.answers.push(transform(answer));
		})
		merge();
	},function(status){
